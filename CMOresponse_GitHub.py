...
census_ageband = pd.read_csv(r"C:\Users\k2143494\OneDrive - King's College London\Documents\Census 2021\LSOA data\census2021-ts007a-lsoa.csv")
...
data_healthbyage = pd.read_csv(r"C:\Users\k2143494\OneDrive - King's College London\Documents\Department of Twin Research\CARICE Unmet Need\Data\HealthByAgeSexDeprivation_Census20212011_LocalAuthority.csv")
...
population_projections = pd.read_csv(r"C:\Users\k2143494\OneDrive - King's College London\Documents\Department of Twin Research\Response to CMO 2023 report\subnationalprojections_mid2018_LAD19version.csv")
...
deprivation_LSOA_lookup_england = pd.read_csv(r"C:\Users\k2143494\OneDrive - King's College London\Documents\Geodata\Deprivation\England 2019\File_2_-_IoD2019_Domains_of_Deprivation.csv")
...
deprivation_LSOA_lookup_wales = pd.read_csv(r"C:\Users\k2143494\OneDrive - King's College London\Documents\Geodata\Deprivation\Wales 2019\welsh-index-multiple-deprivation-2019-index-and-domain-ranks-by-small-area.csv")
...
RUC_LSOA_lookup_englandwales = pd.read_csv(r"C:\Users\k2143494\OneDrive - King's College London\Documents\Geodata\Rural urban\Rural_Urban_Classification_2011_lookup_tables_for_small_area_geographies_EnglandWales.csv")
...
RUC_LAD21 = pd.read_csv(r"C:\Users\k2143494\OneDrive - King's College London\Documents\Geodata\Rural urban\RUC11_LAD21CD_level.csv")
RUC_LAD21_cols = RUC_LAD21.columns.to_list()
# Mapped to Local Authority 2019 boundaries
RUC_LAD19 = pd.read_csv(r"C:\Users\k2143494\OneDrive - King's College London\Documents\Geodata\Rural urban\RUC11_LAD19CD_level.csv")
...
geocode_mapping_2021 = pd.read_csv(r"C:\Users\k2143494\OneDrive - King's College London\Documents\Geodata\Area lookups\OA21_LSOA21_MSOA21_LAD22_EW_LU.csv")
...
geocode_mapping_2021_OAtoRegion = pd.read_csv(r"C:\Users\k2143494\OneDrive - King's College London\Documents\Geodata\Area lookups\OA21_RGN22_LU.csv")
...
# # geocode_mapping_2011 = pd.read_csv(r"C:\Users\k2143494\OneDrive - King's College London\Documents\Geodata\Area lookups\Output_Area_to_LSOA_to_MSOA_to_Local_Authority_District_(December_2017)_Lookup_with_Area_Classifications_in_Great_Britain.csv")
# # geocode_mapping_2011_cols = geocode_mapping_2011.columns.to_list()

# Mapping from LSOA 2011 to 2021
geocode_mapping_2011to2021_LSOA = pd.read_csv(r"C:\Users\k2143494\OneDrive - King's College London\Documents\Geodata\Area lookups\LSOA_(2011)_to_LSOA_(2021)_to_Local_Authority_District_(2022)_Lookup_for_England_and_Wales_(Version_2).csv")
...
LSOA2021_positions = pd.read_csv(r"C:\Users\k2143494\OneDrive - King's College London\Documents\Geodata\Shapefiles\Lower_layer_Super_Output_Areas_2021_EW_BSC_v2_7982568775378104300.csv")

# LSOA 2011 and LAD 2022 to 2022 NHS ICBs and sub-ICB locations
geocode_mapping_LSOA2011toNHS = pd.read_csv(r"C:\Users\k2143494\OneDrive - King's College London\Documents\Geodata\Area lookups\LSOA11_LOC22_ICB22_LAD22_EN_LU.csv")
